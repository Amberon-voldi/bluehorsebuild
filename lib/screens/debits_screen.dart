...
class DebitsScreen extends StatefulWidget {
  const DebitsScreen({super.key, required this.role, required this.username});

  static const String id = "DebitsScreen";

  final String role;
  final String username;

  @override
  State<DebitsScreen> createState() => _DebitsScreenState();
}

class _DebitsScreenState extends State<DebitsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
        future: Apis().getDebitsData(context, widget.role, widget.username),
                              ...
                              if (result) {
                                if (mounted) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content:
                                          Text('Debit submitted successfully'),
                                    ),
                                  );
